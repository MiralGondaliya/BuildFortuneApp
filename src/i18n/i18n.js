...
I18n.translations = {
  en: {
    welcome: 'Welcome',
    welcomeMessage: 'Welcome to Build Fortune,A platform for making fortune',
    ...
    selectNationality:
      'Select country where you would like to buy or sell business?',
    ...
    sellMyBusinessShares: 'Sell my business shares',
    usa: 'USA',
    uk: 'UK',
    uae: 'UAE',
    kuwait: 'Kuwait',
    ...
    foodAndBaveraged: 'Food & baveraged business',
    ...
    business: 'Business',
    details: 'Details',
    searchYourNeeds: 'Search your needs',
    history: 'History',
    keywords: 'Keywords',
    trending: 'Trending',
    ads: 'Ads',
    ...
    solveYourQueries: 'Solve your queries',
    signOut: 'Sign out',
    logoutOrSwitchAccount: 'Logout or switch account',
    support: 'Support',
    settings: 'Settings',
    ...
    getPushNotificationOnAlert: 'Get push notification on alerts',
    smsAlert: 'SMS Alert',
    getSmsNotificationOnAlert: 'Get SMS notification on alerts',
    skip: 'Skip',
    validMessageEmptyEmail: 'Please enter your email address',
    validMessageValidEmail: 'Please enter valid email address',
    validMessageEmptyPassword: 'Please enter password',
    sureWantToLogout: 'Sure want to sign out?',
    cancel: 'Cancel',
    ...
    haveBusinessModal: 'Dose it have a business modal?',
    includeAFasabilityStudy: 'Dose it includes a feasibility study?',
    haveBrandingStrayegy: 'Dose it have a branding strategy?',
    ...
    pleaseEnterTitleInEnglish: 'Please enter title in English',
    pleaseEnterTitleInArabic: 'Please enter title in Arabic',
    establishmentYearShouldBe: 'Establishment year should be 1900 to',
    pleaseEnterEstablishmentYear: 'Please enter establishment year',
    pleaseEnterSellingPrice: 'Please enter selling price',
    pleaseSelectImage: 'Please select image',
    pleaseEnterDescriptionInEnglish: 'Please enter description in English',
    pleaseEnterDescriptionInArabic: 'Please enter description in Arabic',
    pleaseSelectCountry: 'Please select origin country',
    pleaseEnterValidEmail: 'Please enter a valid email address',
    pleaseEnterValidPhoneNumber: 'Please enter a valid phone number',
    pleaseSelectBusinessModal: 'Please select business modal',
    ...
    noAdsCountry: 'No ads for this country',
  ...
  ar: {
    welcome: 'مرحبا',
    welcomeMessage: 'مرحبا بك في بلد فورتشن، طريقك للوصول إلى الثراء',
    ...
    logoutOrSwitchAccount: 'تسجيل الخروج أو تبديل الحساب',
    support: 'المساعدة',
    settings: 'الإعدادات',
    ...
    getSmsNotificationOnAlert: 'الحصول على التنبيهات الفورية عبر SMS',
    skip: 'تخطي',
    ...
    pleaseEnterValidEmail: 'يرجى كتابة إيميل صحيح',
