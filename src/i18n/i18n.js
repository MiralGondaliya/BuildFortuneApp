...
I18n.translations = {
  ...
  ar: {
    ...
    pleaseEnterTitleInEnglish: 'يرجى كتابة عنوان الإعلان الإنجليزي',
    pleaseEnterTitleInArabic: 'يرجى كتابة عنوان الإعلان العربي',
    ...
    locationInformation: 'مقر المشروع',
    ...
    myPreferences: 'إعداداتي',
    businessDetails: 'معلومات المشروع',
