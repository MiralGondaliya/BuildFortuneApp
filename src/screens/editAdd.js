...
const EditAdd = ({route}) => {
  ...
  const apiCallGetMyPostDetail = () => {
    apiCall(
      getMyPostDetail(post_id),
      (data, message) => {
        if (data) {
          if (data) {
            setAddressEnglish(data.post_address_1);
            setAddressArabic(data.post_address_2);
            setBusinessModal(
              data.post_address_1
                ? data.post_address_1 === 1
                  ? I18n.t('yes')
                  : I18n.t('no')
                : '',
            );
            ...
            setMarketingStrategy(
              data.post_answer_4
                ? data.post_address_4 === 1
                  ? I18n.t('yes')
                  : I18n.t('no')
                : '',
            );
            setBusinessNameEnglish(data.post_business_name_1);
            setBusinessNameArabic(data.post_business_name_2);
            setBusinessNameArabic(data.post_business_name_2);
            setSelectedType(
              data.post_type_id === 1
                ? I18n.t('sellMyBusiness')
                : data.post_type_id === 2
                ? I18n.t('sellMyBusinessIdea')
                : I18n.t('sellMyBusinessShares'),
            );
            setCategoryId(data.post_category_id);
            setCategory(data.post_category_name);
            setEmail(data.post_contact_email_id);
            setCountryCodePhoneNumber(data.post_contact_phone_phonecode);
            setPhoneNumber(data.post_contact_phone_no);
            setCheckContactInfo(data.post_contact_visibility == 1);
            setCountryCodeWhatsAppNumber(data.post_contact_whatsapp_phonecode);
            setWhatsAppNumber(data.post_contact_whatsapp_no);
            setCountry(data.post_country_name);
            setCountryId(data.post_country_id);
            setDescriptionEnglish(data.post_description_1);
            setDescriptionArabic(data.post_description_2);
            setEstablishmentYear(data.post_establishment_year);
            setFaceBook(data.post_facebook);
            setAttachImageUri(data.post_image_1);
            setAttachImage(data.post_image_1);
            setAttachImage2(data.post_image_2);
            setAttachImageUri2(data.post_image_2);
            setAttachImageUri3(data.post_image_3);
            setAttachImage3(data.post_image_3);
            setInstagram(data.post_instagram);
            setInvestmentPercentage(data.post_investment_percentage);
            setInvestorCharacteristics(data.post_investor_characteristics_1);
            setInvestorCharacteristicsInArabic(
              data.post_investor_characteristics_2,
            );
            setInvestorFieldOfExp(data.post_investor_field_1);
            setInvestorFieldOfExpInArabic(data.post_investor_field_2);
            setInvestorNationality(data.post_investor_nationality_1);
            setInvestorNationalityInArabic(data.post_investor_nationality_2);
            setLicensed(
              data.post_licensed
                ? data.post_licensed === 1
                  ? I18n.t('yes')
                  : I18n.t('no')
                : '',
            );
            setNoOfStaff(data.post_no_of_staff);
            setSellingPrice(data.post_selling_price);
            setSpace(data.post_space);
            setSpaceRent(data.post_space_rent);
            setTitleInEnglish(data.post_title_1);
            setTitleInArabic(data.post_title_2);
            setTwitter(data.post_twitter);
            setWebsite(data.post_website);
            setYouTube(data.post_youtube);
          }
        } else {
          showErrorMessage(message);
        }
